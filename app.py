...
from extension import (
    ...
    render_edit_player_page,
    render_edit_profile_page,
    render_edit_team_page,
    render_edit_tournament_page,
    render_events_page,
    render_login_page,
    render_register_page,
    render_team_players_page,
    render_teams_page,
    render_tournament_detail_page,
    run_schema_migrations,
)

app = Flask(__name__)
load_local_env(app.root_path)
...
def inject_organizer_emails():
    ...
    return {"organizer_emails": emails}
